...
async function loadProducts() {
    try {
        ...
        showNotification('Erreur lors du chargement des produits. Veuillez vérifier que le serveur est démarré.', 'error');
        
        // Fallback vers le fichier JSON local en cas d'erreur API
        try {
            ...
            displayProducts(products);
            showNotification('Produits chargés depuis le fichier local', 'warning');
        } catch (localError) {
            console.error('Erreur lors du chargement du fichier local:', localError);
