// Configuration pour Console Node.js Infomaniak (serveur unifié)
const CONFIG = {
    // API sur le même serveur (pas besoin du domaine complet)
    API_BASE_URL: '/api',
    
    // Pas de fallback nécessaire avec serveur unifié
